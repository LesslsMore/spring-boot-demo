...
@SpringBootTest
public class mybatis_plus_sqlite_test {
    @Autowired
...
//        });
    ...
    public void insertAll() throws IOException {
        String filePath = "E:\\T\\Documents\\VSCode\\proj\\vue\\vue3-ts-web-proj\\nodejs-bili-part-video-search\\up\\37974444\\bvid\\BV1a34y167AZ.json";
//        new Path(filePath);
        insertItem(filePath);
    }
